...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('administration', '0002_alter_administrationindexpage_tooltip_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='AdministrationFormPage',
            fields=[
                ...
                ('introduction', wagtail.fields.RichTextField(blank=True, help_text='Here you can explain how the gathering works...', null=True, verbose_name='Introduction')),
                ('form', wagtail.fields.StreamField([('form_field', wagtail.blocks.StructBlock([('form', wagtailstreamforms.blocks.FormChooserBlock()), ('form_action', wagtail.blocks.CharBlock(help_text='The form post action. "" or "." for the current page or a url', required=False)), ('form_reference', wagtailstreamforms.blocks.InfoBlock(help_text='This form will be given a unique reference once saved', required=False))], icon='form', label='Form field'))], blank=True, help_text='The main form for to gather informations from the administration.', null=True, verbose_name='Question form')),
                ('date_from', models.DateField(blank=True, help_text='Start date of the survey.', null=True, verbose_name='From')),
                ('date_to', models.DateField(blank=True, help_text='End date of the survey.', null=True, verbose_name='To')),
            ...
            options={
                'verbose_name': 'Administration Form page (survey, form, etc.)',
                'verbose_name_plural': 'Form pages',
            },
            bases=('wagtailcore.page',),
        ),
        migrations.CreateModel(
            name='AdministrationPieceJointe',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='administration_documents', to='administration.administrationformpage')),
            ],
            options={
                'abstract': False,
            },
